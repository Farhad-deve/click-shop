    ...
    <>
      <div className="p-1.75 relative min-h-[calc(100vh-79px)] overflow-hidden max-w-[2000px] mx-auto flex justify-center items-center flex-col gap-3">
        <div className="flex relative z-1 flex-col justify-center items-center gap-3">
          <motion.h1
            className="text-[30px] md:text-[40px] lg:text-[45px] font-bold leading-9 md:leading-12.5 lg:leading-13.75 text-center mx-[5%] text-indigo-700 drop-shadow-md max-w-250"
          ...
          <motion.p
            className="text-gray-600 font-medium text-center max-w-175 mx-[5%] text-[12px] md:text-[14px]"
